...
import {Headphones, Settings, Star, Trophy, Search, Users, Library} from "lucide-react";
        ...
        <header className="sticky top-0 z-50 w-full border-b border-blue-900/40 bg-night/80 backdrop-blur-md">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
                ...
                <Link href="/" className="flex items-center gap-3 group">
                    <div
                        className="p-1 rounded-xl bg-gradient-to-br from-blue-600/20 to-emerald-500/20 group-hover:from-blue-600/30 group-hover:to-emerald-500/30 transition-all border border-blue-500/30">
